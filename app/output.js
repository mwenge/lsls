...
function calculateChunkLength(div) {
  let ph = div.clientHeight;
...
function setUpOutput(div, c = "Output appears here", editable, selectedTheme) {
  let content = c ? c : "";
  let isEditable = editable;
  let chunkLength = calculateChunkLength(div);
